...
INSERT INTO dq_donation_products (id, slug, title, description, image_url, price, currency, category, stock_status, cta_label, cta_url, kind, sort_order, is_active, published) VALUES
  ('30010001-0000-4000-8000-000000000001', 'single-quran-donation',    'Single Qur''an Donation',    'Sponsor one beautifully bound Qur''an for someone in need.',                          'https://images.unsplash.com/photo-1609599006353-e6a9e0c121ff?w=600&h=400&fit=crop',  10.00,  'USD', 'Donation',  'Available',   'DONATE', '/donate/single',    'product', 1, true, true),
  ('30010001-0000-4000-8000-000000000002', 'family-quran-package',     'Family Qur''an Package',     'Provide four Qur''ans for a household to read and learn together.',                    'https://images.unsplash.com/photo-1589998059171-988d887df646?w=600&h=400&fit=crop',  40.00,  'USD', 'Package',   'In Stock',    'DONATE', '/donate/family',    'product', 2, true, true),
  ('30010001-0000-4000-8000-000000000003', 'quran-app',                'The Qur''an App',            'Support our digital platform with translation, audio, and study tools.',              'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=600&h=400&fit=crop',   5.00,  'USD', 'Digital',   'Free Access', 'DONATE', '/donate/app',       'product', 3, true, true),
  ('30010001-0000-4000-8000-000000000004', 'bulk-donation',            'Bulk Donation',              'Sponsor a full pallet of Qur''ans for mass community distribution.',                  'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&h=400&fit=crop', 500.00,  'USD', 'Bulk',      'By Request',  'DONATE', '/donate/bulk',      'product', 4, true, true),
  ('30010001-0000-4000-8000-000000000005', 'student-sponsorship',      'Student Sponsorship',        'Fund Qur''ans for students in schools and madrasahs.',                                'https://images.unsplash.com/photo-1542816417-0983c9c9ad14?w=600&h=400&fit=crop',    25.00,  'USD', 'Education', 'Available',   'DONATE', '/donate/students',  'product', 5, true, true),
  ('30010001-0000-4000-8000-000000000006', 'monthly-subscription',     'Monthly Subscription',       'Give monthly and sustain ongoing Qur''an distribution year-round.',                   'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&h=400&fit=crop',   15.00,  'USD', 'Recurring', 'Active',      'DONATE', '/donate/monthly',   'product', 6, true, true),
  ('30010001-0000-4000-8000-000000000007', 'ramadan-special-pack',     'Ramadan Special Pack',       'Seasonal bundle: Qur''ans plus Ramadan reading guides for families.',                 'https://images.unsplash.com/photo-1519682577862-22b962b24b2b?w=600&h=400&fit=crop',   35.00,  'USD', 'Seasonal',  'Limited',     'DONATE', '/donate/ramadan',   'product', 7, true, true),
  ('30010001-0000-4000-8000-000000000008', 'sadaqah-jariyah-fund',     'Sadaqah Jariyah Fund',       'Contribute to ongoing charity — every Qur''an keeps giving reward.',                  'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop',  50.00,  'USD', 'Fund',      'Open',        'DONATE', '/donate/sadaqah',   'product', 8, true, true)
...
-- -----------------------------------------------------------------------------
INSERT INTO dq_donation_products (id, slug, title, description, image_url, price, currency, category, stock_status, cta_label, cta_url, kind, sort_order, is_active, published) VALUES
  ('31010001-0000-4000-8000-000000000001', 'flagship-sponsorship',         'The Qur''an Project — Flagship Sponsorship',  'Become a flagship partner funding large-scale distribution campaigns across multiple regions.',  'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/flagship',     'quick', 1, true, true),
  ('31010001-0000-4000-8000-000000000002', 'quran-distribution-hardcopy',  'Qur''an Distribution (Hardcopy)',             'Fund printing and delivery of physical Mushaf copies to underserved communities.',               'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/distribution', 'quick', 2, true, true),
  ('31010001-0000-4000-8000-000000000003', 'publishing-translation',       'Publishing & Translation Support',            'Help produce new translations and editions for non-Arabic speaking communities.',              'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/publishing',   'quick', 3, true, true),
  ('31010001-0000-4000-8000-000000000004', 'mushaf-print-fund',            'Mushaf Print Fund',                           'Sponsor a print run of premium Mushaf editions for waiting communities.',                      'https://images.unsplash.com/photo-1589998059171-988d887df646?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/mushaf',       'quick', 4, true, true),
  ('31010001-0000-4000-8000-000000000005', 'marketing-outreach',           'Marketing & Outreach',                        'Expand our reach through campaigns, events, and educational content worldwide.',               'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/marketing',    'quick', 5, true, true),
  ('31010001-0000-4000-8000-000000000006', 'prison-outreach',              'Prison & Institutional Outreach',           'Deliver Qur''ans to correctional facilities and institutions seeking guidance.',               'https://images.unsplash.com/photo-1488523785076-6ef0109c1b44?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/prison',       'quick', 6, true, true),
  ('31010001-0000-4000-8000-000000000007', 'refugee-relief',               'Refugee Relief Qur''an Fund',                 'Provide Qur''ans to displaced families rebuilding their lives.',                               'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/refugee',      'quick', 7, true, true),
  ('31010001-0000-4000-8000-000000000008', 'new-muslim-welcome-kit',       'New Muslim Welcome Kit',                      'Fund welcome packages with Qur''an, transliteration guide, and learning resources.',             'https://images.unsplash.com/photo-1609599006353-e6a9e0c121ff?w=800&h=500&fit=crop', NULL, 'USD', 'Campaign', 'Open', 'DONATE NOW', '/donate/welcome-kit',  'quick', 8, true, true)
ON CONFLICT (slug) DO UPDATE SET
  title = EXCLUDED.title, description = EXCLUDED.description, image_url = EXCLUDED.image_url,
  cta_label = EXCLUDED.cta_label, cta_url = EXCLUDED.cta_url, kind = EXCLUDED.kind,
  sort_order = EXCLUDED.sort_order, is_active = EXCLUDED.is_active, published = EXCLUDED.published,
...
INSERT INTO dq_articles (id, slug, title, excerpt, cover_image_url, category, author_id, body_html, read_time, status, published_at) VALUES
  ...
  (
    ...
    '<p>Every dollar is allocated to printing, logistics, and local partners who know their communities best. Transparency is our promise.</p>',
